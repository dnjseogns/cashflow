    ...
    return(
        <Fragment>
            ...
            <div>
                ...
                <p>- 차량 유지비(사전정보) : <input className='btn1 readonly' value={surveyData.prev?.carCostMonthly ?? 0} readOnly={true}/> 만원</p>
                <p>- 주거비(사전정보) : <input className='btn1 readonly' value={surveyData.prev?.houseCostMonthly ?? 0} readOnly={true}/> 만원</p>
