...
const Fire = ({children}) => {
    ...
    return (
        ...
        <div className="case-study-conten-top">
            ...
            <p>
                A : 28세(초봉2900만,저축50%,투자수익10%) → 42세(은퇴, 전세3억, 차량구매) → 55세(은퇴 후 재취업하여 65세까지 근무) → 65세(국민연금수령)
                <br/>B : 28세(초봉1억만,저축80%,투자수익4%) → 42세(은퇴, 전세3억, 차량구매) → 55세(은퇴 후 재취업하여 65세까지 근무) → 65세(국민연금수령)
            </p>
        </div>
        {children}
        ...
        <div className="case-study-conten-bottom">
            ...
            <p>
                <span>파이어족이 되기 위해선, 극단적인 소득 또는 투자수익이 있어야 한다는 점을 시뮬레이션하고자 하였습니다.</span>
                <br/><span>또한 연 투자수익률 10%이상은 엄청난 복리효과가 있다는 점도 보여지고 있습니다.</span>
            </p>
        </div>
        </Fragment>
    )
