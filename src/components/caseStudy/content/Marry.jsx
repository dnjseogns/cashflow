    ...
    return (
        ...
        <div className="case-study-conten-bottom">
            ...
            <p>
                ...
                <br/>B : 28~55세(초봉2900만,저축40%이상) → 34세(결혼 맞벌이, 전세3억, 아반떼구매, 부모님지원X) → 40세(집매매6억) → 56~65세(재취업,기존연봉60%) → 65세(국민연금수령)
                <br/>C : 28~55세(초봉2900만,저축40%이상) → 34세(결혼 맞벌이, 매매6억, 아반떼구매, 부모님지원3억) → 56~65세(재취업,기존연봉60%) → 65세(국민연금수령)
            </p>
