...
const Yolo = ({children}) => {
    ...
    return (
        ...
        <div className="case-study-conten-top">
            ...
            <p>A : 28세(초봉2900만,저축10%) → 35세(결혼, 전세3억, 차량구매) → 55세(은퇴 후 재취업하여 65세까지 근무) → 65세(국민연금수령)</p>
        </div>
        {children}
        ...
        <div className="case-study-conten-bottom">
            ...
            <p>
                ...
                <br/><span>위 그래프에서 주목할 점은, 55세~65세 재취업하여 근소소득이 있음에도 소비를 통제하지 못하여 자산이 계속해서 감소한다는 점입니다.</span>
                <br/><span>그리고 예상한대로, 근로소득이 끊기는 시점으로부터 멀지 않는 나이인 72세부터 마이너스 자산에 도달하게 됩니다.</span>
