...
const Old = ({children}) => {
    ...
    return (
        ...
        <div className="case-study-conten-bottom">
            ...
            <p>A : 28~55세(초봉2900만,저축40%이상) → 34세(결혼 맞벌이, 전세3억, 아반떼구매) → 36세(아이 1명 출산) → 40세(집매매6억) → 56~65세(재취업,기존연봉60%) → 65세(국민연금수령)</p>
            ...
            <p>
                ...
                <br/>100세 : 유동자산은 거의 0원으로 모두 사용하였지만, 자식에게 물려줄 집이라도 있어서 다행이라고 생각합니다.
            </p>
